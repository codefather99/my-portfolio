    ...
    <div className="relative w-full h-screen bg-white">
      ...
      <main className=" h-screen overflow-x-hidden overflow-y-scroll leading-loose scroll-quick scroll-smooth lg:snap-y lg:snap-mandatory scrollbar-hide overscroll-none  relative z-10">
        ...
        <section id="/" className="w-full lg:h-screen flex md:flex-row flex-col relative lg:snap-start  ">
          ...
          <div className="hidden  lg:w-1 lg:opacity-100 opacity-0 w-full h-full bg-[#64FFDA]"></div>
          <div className="md:w-[33%]  w-full lg:h-full h-[3/4] bg-[#64FFDA] relative  ">
          ...
          {/* <Image
            ...
            width={70}
            height={70}
            className="relative right-60 bottom-40 opacity-100 rotate-60"
          />
          ...
          <Image
            ...
            width={70}
            height={70}
            className="relative right-55 bottom-70 opacity-100 "
          /> */}
         <div className="flex w-full h-full justify-center items-center ">
            <Image
              ...
              width={700}
              height={700}
              className="md:min-w-[700px] relative right-5  md:right-20  lg:right-50 2xl:right-70 3xl:right-100 bottom-5"
              //  className=" mx-auto  lg:w-[100vw] bottom-50  relative  md:left-[-360px] lg:left-[-400px] md:bottom-30 lg:top-10   md:min-w-[700px] w-auto h-auto"
            />
        </div>
          </div>
        ...
        {/* About Section */}
        <section id="about" className="w-full xl:h-screen h-auto  flex lg:flex-row xl:space-evenly flex-col lg:items-center lg:justify-center bg-white lg:snap-start">
          ...
          >
            <div className="relative lg:w-full flex-col justify-center gap-6 py-15 my-5 lg:my-0 px-15 md:flex-row lg:gap-0 lg:px-0 lg:py-30 xl:py-0 flex  ">
            <Image
            src="/svg/shape30.png"
            alt=""
            width={40}
            height={80}
            className="hidden xl:block xl:absolute right-35 bottom-10 "
          />
            ...
            width={70}
            height={70}
            className="hidden xl:block xl:absolute xl:absolute right-65 bottom-30 "
          />
...
<Image
            ...
            width={70}
            height={70}
            className="hidden xl:block xl:absolute left-5 top-10"
          />
            ...
            width={70}
            height={70}
            className=" hidden xl:block xl:absolute left-45 top-30   rotate-30"
          />

              <div className="xl:absolute relative lg:pr-10 mb-10 lg:mb-0 lg:bottom-0 lg:left-0 max-w-md text-left">
            ...
            You’ll find me deep in stylesheets, obsessing over font pairings and crafting layouts that just feel right.
             I blend aesthetics with functionality, ensuring every experience is seamless, engaging, and, of course, effortlessly stylish. 
              ...
              <div className="xl:absolute relative  lg:top-0 lg:right-0 max-w-md text-left">
        ...
        {/* Work Experience */}
        <section id="work" className="w-full xl:h-screen h-auto flex  bg-[#0A192F] lg:snap-start">
          <div className="flex h-full lg:flex-row flex-col max-w-screen-xl mx-auto ">
            <div className="lg:max-w-[50%] flex flex-col bg-[#0A192F]  justify-center pl-12 pr-5 lg:pr-0 h-full lg:pl-[7.5rem] lg:py-20 py-10 xl:py-5 ">
          ...
          Equipped With over 6 years of experience, including freelancing as a frontend developer—crafting responsive, user-focused web experiences for clients across different industries.        </p>
            ...
            <Image
              ...
              width={500}
              height={500}
              className="m-auto xl:mt-20 p-10 xl:p-0"
            />
            </div>
          </div>
        </section>
        ...
        {/* Portfolio/Blog */}
        <section id="portfolio" className="w-full xl:h-screen h-auto lg:pt-40 xl:pt-0 lg:mt-0 mt-10 xl:mt-10 flex justify-center items-center  bg-white lg:snap-start">
  <div className="lg:max-w-6xl lg:h-[50%] xl:h-[80%] lg:w-full flex md:flex-row flex-col lg:justify-between items-center  px-8 bg-[#F4FDFC] lg:bg-white xl:bg-[#F4FDFC] rounded-md ">
    {/* Left Section */}
    <div className="lg:w-1/2 lg:pl-20 xl:pl-10 pr-20 lg:pr-0 py-10 lg:py-0">
    ...
    {/* Divider Line */}
    <div className="hidden xl:block h-full w-[1px] bg-[#0A192F] opacity-50"></div>

    {/* Right Section */}
    <div className="lg:w-1/2  pr-20 lg:pr-0 lg:pl-25 pb-10 lg:py-0 md:py-10 lg:pb-0">
...
<section id="contact" className="w-full xl:h-screen my-20 xl:my-0 pt-10 xl:pt-0 flex flex-col items-center justify-center bg-white px-6 text-center lg:snap-start">
